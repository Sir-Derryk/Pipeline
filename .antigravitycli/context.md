...
## 🗺️ Текущий шаг
Выполняется реструктуризация спецификаций: разделение монолитных BRD, SRS и SDD на древовидную структуру страниц, добавление раздела Release Planning (Roadmap) с трассировкой требований по версиям релиза и версионирование документа на уровне 0.1 (Requirements Gathering).
